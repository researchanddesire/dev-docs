...
<Info>
This page describes RADR acting as a BLE central for other devices. To connect to RADR itself as a controllable peripheral, use the shared [RAD BLE v1 namespace and channel layout](/integrations/rad-ble).
</Info>
