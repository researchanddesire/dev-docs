...
Read the [contribution guidelines](https://github.com/researchanddesire/radr-wireless-remote/blob/main/CONTRIBUTING.md) before submitting a change against the `main` branch.
...
RADR firmware is released under the **CERN Open Hardware Licence Version 2 - Strongly Reciprocal (CERN-OHL-S v2)**. See the repository [license](https://github.com/researchanddesire/radr-wireless-remote/blob/main/LICENSE) for details.
