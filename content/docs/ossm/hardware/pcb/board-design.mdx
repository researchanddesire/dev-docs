...
<Info>
The following setups are validated integration patterns. Hardware revisions can require different pin assignments, so verify the applicable board, driver, and motor specifications.
</Info>
