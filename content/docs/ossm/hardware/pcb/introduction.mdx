...
<Step title="Gather parts">
  ...
  <Note>
  For physical assembly and wiring, use the <a href="https://ohai.researchanddesire.com/ossm/cable-harnesses">official wiring stage</a>.
  </Note>
</Step>
...
<CardGroup cols={2}>
  <Card title="OSSM PCB reference" icon="file" href="/ossm/hardware/pcb/board-design">
    Detailed electrical specifications and connector pinouts.
  </Card>
  <Card title="Official wiring stage" icon="bolt" href="https://ohai.researchanddesire.com/ossm/cable-harnesses">
    Step‑by‑step wiring for the OSSM Gold Motor (57AIM series).
  </Card>
  <Card title="Firmware and updates" icon="cpu" href="/ossm/software/getting-started/wifi-and-updates">
