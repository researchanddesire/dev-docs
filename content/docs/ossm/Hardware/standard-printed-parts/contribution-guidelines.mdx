...
<Frame caption="Overview of the OSSM standard printed parts structure">
  <img src="./_images/Overview.webp" alt="Overview of the OSSM standard printed parts file structure in Fusion 360" />
</Frame>

## Project template

Use the contribution template located in the Templates directory (in the source repository) as your starting point. Replace "Project Name" in the Document and Component with your actual project name.
...
- Convert `.stp` to `.stl` at high-quality refinement and bundle into `OSSM-Hardware/ossm/Hardware/OSSM Printed Parts` release
...
<Frame caption="ExportIt Export tab configuration">
  <img src="./_images/ExportIt_Export.webp" alt="ExportIt Export tab showing recommended export settings" />
</Frame>

#### Location tab

<Frame caption="ExportIt Location tab configuration">
  <img src="./_images/ExportIt_Location.webp" alt="ExportIt Location tab showing directory settings" />
</Frame>

#### Misc tab

<Frame caption="ExportIt Misc tab configuration">
  <img src="./_images/ExportIt_Misc.webp" alt="ExportIt Misc tab showing miscellaneous options" />
</Frame>
