...
<CardGroup cols={3}>
<Card title="Hide display time (user feature)" icon="eye-off" href="https://docs.researchanddesire.com/lockbox/start-end-lock">
How the UI hides remaining time across device, dashboard, and notifications.
</Card>

<Card title="Emergency unlock display flow" icon="alert-triangle" href="https://docs.researchanddesire.com/lockbox/emergency-unlock">
Screen flow and consequences of triggering Emergency Unlock on device.
</Card>

<Card title="Device support matrix" icon="list" href="https://docs.researchanddesire.com/radr/supported-devices">
