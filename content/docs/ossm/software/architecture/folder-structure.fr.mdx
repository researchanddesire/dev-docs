...
<Tip>
Pour plus de détails sur le fonctionnement de la machine à états, voir [Architecture de la machine à états](/ossm/software/architecture/state-machine).
</Tip>
...
<Info>
Pour plus de détails sur le protocole BLE, voir [Communication BLE](/ossm/software/communication/ble).
</Info>
...
[Boost.SML](https://boost-ext.github.io/sml/) est une bibliothèque de machine à états composée uniquement d'en-têtes. Elle est incluse directement dans le projet pour la stabilité des versions.

### StrokeEngine (`lib/StrokeEngine/`)

Une version modifiée de [theelims/StrokeEngine](https://github.com/theelims/StrokeEngine) qui génère des motifs de mouvement. La bibliothèque est fournie et personnalisée pour les exigences spécifiques à OSSM.
...
<Card title="Machine à états" icon="diagram-project" href="/ossm/software/architecture/state-machine">
  Découvrez en détail l’architecture de la machine à états Boost.SML.
</Card>

<Card title="Configuration" icon="sliders" href="/ossm/software/getting-started/configuration">
  Personnalisez les paramètres de mouvement, les broches et les réglages.
</Card>
...
<Card title="Communication BLE" icon="bluetooth" href="/ossm/software/communication/ble">
  Comprenez le protocole et les caractéristiques Bluetooth.
</Card>
</CardGroup>
