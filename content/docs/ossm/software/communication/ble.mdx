...
<Warning>
This page documents the OSSM compatibility characteristics. New integrations should use the shared [RAD BLE v1 namespace and channel layout](/integrations/rad-ble), which also covers RADR, DTT, and LKBX.
</Warning>
...
The pipe character (`|`) is used as a delimiter between SSID and password. This allows both SSID and password to contain colons.
...
<Tip>
For funscript playback, see the [Funscript Player](/ossm/software/communication/ble#streaming-mode) tool which handles timing and command generation automatically.
</Tip>
