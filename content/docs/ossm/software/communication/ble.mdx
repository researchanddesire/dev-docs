...
<Tip>
For funscript playback, see the [Funscript Player](/ossm/software/communication/ble#streaming-commands-experimental) tool which handles timing and command generation automatically.
</Tip>
