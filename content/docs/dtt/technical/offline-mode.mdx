...
<AccordionGroup>
<Accordion title="Offline mode won't start">
...
<Accordion title="Results didn't sync after reconnecting">
...
<Accordion title="Wrong template loads offline">
...
Offline session syncing (storing multiple sessions for later upload) is planned for a future firmware release. See the <a href="/dtt/technical/introduction">Software 2.0 Preview</a> for upcoming features.
...
<Card title="Checking Results" icon="chart-line" href="https://docs.researchanddesire.com/dtt/results">
