...
<Tip>
The Wi-Fi configuration portal has a 400-second timeout. If it expires, the device will restart.
</Tip>
...
| **Bad Health Check** | Error E-DTT-1 — see <a href="https://docs.researchanddesire.com/dtt/troubleshooting">troubleshooting guide</a> |
...
See the <a href="https://docs.researchanddesire.com/dtt/troubleshooting">Error Codes</a> guide for detailed troubleshooting.
...
<CardGroup cols={2}>
<Card title="Button Controls" icon="hand-pointer" href="https://docs.researchanddesire.com/dtt/get-started">
Complete guide to button interactions.
</Card>

<Card title="Error Codes" icon="triangle-exclamation" href="https://docs.researchanddesire.com/dtt/troubleshooting">
